...
public class SecurityConfig_Backup {
     ...
     * This uses the modern Lambda DSL for configuration.
     */
    @Bean
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            // 3. Configure session management to be stateless, as we are using JWTs.
            .sessionManagement(session -> session.sessionCreationPolicy(SessionCreationPolicy.STATELESS))

            // 4. Set the custom authentication provider.
            .authenticationProvider(authenticationProvider())

            // 5. Add our custom JWT filter to be executed before the standard username/password filter.
            .addFilterBefore(jwtFilter, UsernamePasswordAuthenticationFilter.class)
            
            // 6. Explicitly enable and configure support for anonymous users.
            // This is crucial for permitAll() to work correctly for unauthenticated requests.
